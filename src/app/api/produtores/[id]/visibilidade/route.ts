...
/**
 * PATCH /api/produtores/[id]/visibilidade
 * Body: { ocultar: boolean, nota?: string }
 * 🔒 Exclusivo do dev.
 */
export async function PATCH(
  ...
  try {
    ...
    const produtor = await toggleVisibilidade({
      cadastro: 'produtores',
      id,
      ocultar,
      nota,
    ...
    console.error('Erro ao alterar visibilidade do produtor:', error)
    return NextResponse.json(
